...
class DataProcess:
    ...
    def sync_account_fund_profit_share_fixed_interest(self):
        ...
        try:
            ...
            fund_profit_share_fixed_interest_sql = """
                                select id,fund_currency_mark,fund_finance_type,coin_num_cur_price,usd_num_cur_price,coin_num_client_asset,usd_num_client_asset,coin_num_company_asset,usd_num_company_asset,
	                                                   coin_num_client_profit,usd_num_client_profit,coin_num_float_profit,                  
										...
										from(   select id,fund_currency_mark,fund_finance_type,coin_num_cur_price,usd_num_cur_price,coin_num_client_asset,usd_num_client_asset,coin_num_company_asset,usd_num_company_asset,
			                                    ...
			                                    (usd_num_cur_price+usd_num_float_profi_dr-usd_num_client_asset-usd_num_company_asset-usd_num_client_profit)   as  usd_num_float_profi_cr
	                                            from (  select  b.id as id,a.fund_currency_mark as fund_currency_mark,
			                                                    ...
			                                                    -1*(coin_num_cur_price+coin_num_client_asset+coin_num_company_asset+coin_num_client_profit) as  coin_num_float_profit,c.price_usdt
            ...
            result = self.__ch_conn.execute(fund_profit_share_fixed_interest_sql)
            print(fund_profit_share_fixed_interest_sql)
            print(result['data'])
            ...
            if result['code']:
                ...
                for item in result['data']:
                    ...
                    journal_entry = {"date": str(self.stime.date()),
                                 "ref": "<%s> Fixed Rate Guaranteed Fund return"%(item[1]),
                                 "journal_id": 56,
                                 "company_id": 24,
                                 "currency_id": 2}
...
def main():
    ...
    func_list = ['sync_account_fund_profit_share_fixed_interest']
