...
class DataProcess:
    ...
    def sync_spot_rebate_received(self):
        ...
        try:
            ...
            spot_sql = """
                ...
                where  receive_status = 1 and update_time >= toUnixTimestamp('{}') and update_time < toUnixTimestamp('{}') and trade_type = 0
...
def main():
    ...
    func_list = ['sync_spot_rebate_received']
