...
class DataProcess:
    ...
    def sync_derivative_rebate(self):
        ...
        try:
            ...
            margin_sql = """
                ...
                where  trade_time >= toUnixTimestamp('{}') and trade_time < toUnixTimestamp('{}') and trade_type in (1, 2)
...
def main():
    ...
    func_list = ['sync_derivative_rebate']
