...
class DataProcess:
    ...
    def sync_account_fund_clear_supervise(self):
        ...
        try:
            ...
            fund_clear_supervise_sql = """
 select  b.id as id,a.fund_currency_mark as fund_currency_mark,
            ...
            result = self.__ch_conn.execute(fund_clear_supervise_sql)
            print(fund_clear_supervise_sql)
            print(result['data'])
            if result['code']:
                ...
                for item in result['data']:
                    ...
                    journal_entry = {"date": str(self.stime.date()),
                                 "ref": "<%s> Supervised Fund settlement"%(item[1]),
                                 "journal_id": 56,
                                 "company_id": 24,
                                 "currency_id": 2}
...
def main():
    ...
    func_list = ['sync_account_fund_clear_supervise']
