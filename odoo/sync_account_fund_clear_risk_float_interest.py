...
class DataProcess:
    ...
    def sync_account_fund_clear_risk_float_interest(self):
        ...
        try:
            ...
            fund_clear_risk_float_interest_sql = """
                                 select id,fund_currency_mark,fund_finance_type,coin_num_client_profit,usd_num_client_profit_dr,usd_num_client_profit_cr,coin_num_client_mange,usd_num_client_mange,coin_num_fair_value_change,                   
										...
										from(   select id,fund_currency_mark,fund_finance_type,coin_num_client_profit,usd_num_client_profit_dr,usd_num_client_profit_cr,coin_num_client_mange,usd_num_client_mange,
			                                    ...
			                                    (usd_num_client_profit_dr+usd_num_float_profit_dr+usd_num_client_mange+usd_num_fair_value_change_dr-usd_num_client_profit_cr-usd_num_float_profit_cr) as  usd_num_fair_value_change_cr
	                                            from (  select  b.id as id,a.fund_currency_mark as fund_currency_mark,
			                                                    ...
			                                                    toDecimal256(a.manage_fee*c.price_usdt, 6) as  usd_num_client_mange,
            ...
            result = self.__ch_conn.execute(fund_clear_risk_float_interest_sql)
            print(fund_clear_risk_float_interest_sql)
            print(result['data'])
            if result['code']:
                ...
                for item in result['data']:
                    ...
                    journal_entry = {"date": str(self.stime.date()),
                                 "ref": "<%s> Float Rate Non-Guaranteed Fund settlement"%(item[1]),
                                 "journal_id": 56,
                                 "company_id": 24,
                                 "currency_id": 2}
...
def main():
    ...
    func_list = ['sync_account_fund_clear_risk_float_interest']
