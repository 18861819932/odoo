    ...
    def sync_margin_rebate(self):
        ...
        try:
            ...
            margin_sql = """
                ...
                where  trade_time >= toUnixTimestamp('{}') and trade_time < toUnixTimestamp('{}') and trade_type = 3
            ...
            if result['code']:
                ...
                journal_entry = {"date": str(self.stime.date()),
                                 "ref": "margin trade rebate accrual",
                                 "journal_id": 52,
                                 "company_id": 24,
                                 "currency_id": 2}
