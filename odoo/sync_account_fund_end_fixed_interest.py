...
class DataProcess:
    ...
    def sync_fund_end_fixed_interest(self):
        ...
        try:
            ...
            fund_end_fixed_interest_sql = """
                ...
                where  toDate(b.stime) =if('{}'>='2022-12-01','{}','2022-12-01')  and e.fund_type = '保本固息'
            ...
            result = self.__ch_conn.execute(fund_end_fixed_interest_sql)
            print(fund_end_fixed_interest_sql)
            print(result['data'])
            ...
            if result['code']:
                ...
                for item in result['data']:
                    ...
                    journal_entry = {"date": str(self.stime.date()),
                                 "ref": "<%s> Fixed Rate Guaranteed Fund withdraw"%(item[1]),
                                 "journal_id": 56,
                                 "company_id": 24,
                                 "currency_id": 2}
...
def main():
    ...
    func_list = ['sync_fund_end_fixed_interest']
