...
日期    : 2023/1/3 5:09 PM
作者    : wushuang
功能    : "合约代理返佣，实际领取部分 agent trade rebate"
参数    : 
"""
...
class DataProcess:
    ...
    def sync_derivative_rebate_received(self):
        ...
        try:
            ...
            margin_sql = """
                ...
                where  receive_status = 1 and update_time >= toUnixTimestamp('{}') and update_time < toUnixTimestamp('{}') and trade_type in (1, 2)
            ...
            if result['code']:
                ...
                journal_entry = {"date": str(self.stime.date()),
                                 "ref": "contract agency rebat paid",
                                 "journal_id": 53,
                                 "company_id": 24,
                                 "currency_id": 2}
...
def main():
    ...
    func_list = ['sync_derivative_rebate_received']
