...
class DataProcess:
    ...
    def sync_perpetual_fee(self):
        ...
        try:
            ...
            result = self.__ch_conn.execute(perpetual_fee_sql)
            journal_items = []
            if result['code']:
                ...
                journal_entry = {"date": str(self.stime.date()),
                                 "ref": "tx fee charged on contract",
                                 "journal_id": 53,
                                 "company_id": 24,
                                 "currency_id": 2}
