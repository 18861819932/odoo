...
class DataProcess:
    ...
    def sync_margin_rebate_received(self):
        ...
        try:
            ...
            margin_sql = """
                ...
                where  receive_status = 1 and update_time >= toUnixTimestamp('{}') and update_time < toUnixTimestamp('{}') and trade_type = 3
...
def main():
    ...
    func_list = ['sync_margin_rebate_received']
